...
public class Pedido {
	...
	public void agregarProducto(Producto producto) {
		Producto copiaProducto = producto.clone();
		
		listadoPedido.add(copiaProducto);
		precioTotal += copiaProducto.calcularPrecio();
	}
	//getter y setter
